    ...
    public static void main(String args[]){
        ...
        while(!ui.isEmpty()){
            ...
            for(int i= 0; i< numVariables; i++){
                ...
                /*
                myClass ipData= new myClass();
                ipData.hValue= heuristic(newExp);
                ipData.expression= currVariables;
                */
                ui.add(heuristic(newExp));
                
                /*
                myClass letsee;
                letsee= (myClass)ui.peek();
                prtVariable= letsee.expression;
                if(letsee.hValue== 0){
                    System.out.println("Answer: Heuristic Value: "+ letsee.hValue+ "\n");
                    for(int j=0; j< numVariables; j++){
                        System.out.println(""+prtVariable[j] +"\t");
                    }
                    System.exit(0);
                }
                */
